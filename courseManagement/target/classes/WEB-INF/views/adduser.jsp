					...
					<div class="col s12 m12 l6 left">
						<div class="MDC-explore-text-position left">
							<div class="MDC-title-font">
								...
								<font class="MDC-color-grey-light2">/</font>
								<font class="MDC-color-blue-dark">New User</font>
								<font class="MDC-color-grey-light2">/</font>
							</div>
						</div>
					</div>
					...
					<div class="col s12 m12 l9">
						<div id="profile-card" class="MDC-card mdc-profile-card-size">
							<div class="mdc-profile-card-container">
								...
								<form:form id="profile-form" method="POST" modelAttribute="user" class="form-horizontal" autocomplete="off">
									
									<div class="input-field col s12 m6 l6">
										<form:input placeholder="First Name" id="firstName" type="text" path="firstName" length="15"
											class="mdc-border-grey-light3 MDC-form-border-size"/>
										<label for="firstName">First Name</label>
									</div>
									
									<div class="input-field col s12 m6 l6">
										<form:input placeholder="Last Name" id="lastName" type="text" path="lastName" length="25"
											class="mdc-border-grey-light3 MDC-form-border-size"/>
									...
									<div class="input-field col s12 m6 l6">
										<form:input placeholder="Email" id="email" type="email" path="email"
											value="" autocomplete="off" class="mdc-border-grey-light3 MDC-form-border-size"/>
										<label for="email">Email</label>
									</div>
									
									<div class="input-field col s12 m6 l6">
										<form:input value="" placeholder="Username" id="username" type="text" path="username" length="15" 
										autocomplete="off" class="mdc-border-grey-light3 MDC-form-border-size"/>
										<label for="username">Username</label>
									</div>
									
											
									<div class="input-field col s12 m6 l6">
										<form:input value="" placeholder="Password" id="password" type="password" path="password" 
											autocomplete="off" class="mdc-border-grey-light3 MDC-form-border-size"/>
										<label for="password">Password</label>
									</div>
									
									<div class="input-field col s12 m6 l6">
										<form:input placeholder="Job Description" id="jobDesc" type="text" path="jobDesc" length="15"
											class="mdc-border-grey-light3 MDC-form-border-size"/>
										<label for="jobDesc">Job Description</label>
									</div>
									<div class="input-field col s12 m6 l6">
										<div id="profile-user_type_div" class="mdc-profile-option-size">
											<form:select placeholder="User Type" id="userProfiles" path="userProfiles"  itemValue="id" 
